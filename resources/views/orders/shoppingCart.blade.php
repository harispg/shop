...
<!-- Breadcrumbs -->
      <section class="g-brd-bottom g-brd-gray-light-v4 g-py-30">
        <div class="container">
          <ul class="u-list-inline">
            ...
            <li class="list-inline-item g-mr-5">
              <a class="u-link-v5 g-color-text" href="{{route('articles.index')}}">Articles</a>
              <i class="g-color-gray-light-v2 g-ml-5 fa fa-angle-right"></i>
            </li>
      ...
      <div class="container g-pt-100 g-pb-70">
        <form method="POST" action="{{route('orders.update', ['order'=>$order->id])}}"class="js-validate js-step-form" data-progress-id="#stepFormProgress" data-steps-id="#stepFormSteps">
          @csrf
                      ...
                      <tbody>
                        ...
                        <tr class="g-brd-bottom g-brd-gray-light-v3">
                          <td class="text-left g-py-25">
                            <img class="d-inline-block g-width-100 mr-4" src="/{{$item->photo()->thumbnail_path}}" alt="Image Description">
                          ...
                          <td class="g-color-gray-dark-v2 g-font-size-13">$ {{$item->price()}}</td>
                          <td>
                            <div class="js-quantity input-group u-quantity-v1 g-width-80 g-brd-primary--focus">
                              <input name="quantities[{{$item->id}}]"class="js-result form-control text-center g-font-size-13 rounded-0 g-pa-0" type="text" value="{{$item->quantity}}" data-item="{{$item->id}}" data-price="{{$item->price()}}">
                          ...
                          <td class="text-right g-color-black">
                            <span id="item-value{{$item->id}}" class="item-value g-color-gray-dark-v2 g-font-size-13 mr-4">$ {{$item->total()}}</span>
                            <span class="g-color-gray-dark-v4 g-color-black--hover g-cursor-pointer">
                              <i class="mt-auto fa fa-trash" data-item="{{$item->id}}"></i>
                            </span>
                          </td>
                          @if($errors->has("quantities.".$key))
                          <span class="text-danger">{{$errors->first("quantities.*")}}</span>
                          @endif
                        </tr>
                ...
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="g-bg-gray-light-v5 g-pa-20 g-pb-50 mb-4">
                    ...
                    <div class="d-flex justify-content-between mb-2">
                      ...
                      <span class="subtotal g-color-black g-font-weight-300">$ {{$order->subTotal()}}</span>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                      ...
                      <span class="total g-color-black g-font-weight-300">$ {{$order->orderTotal()}}</span>
                    </div>
                  </div>
                  <!-- End Summary -->

                  <a class="btn btn-block u-btn-primary g-font-size-13 text-uppercase g-py-15 mb-4" href="{{route('articles.index')}}">Continue shopping</a>
              ...
              <div class="row">
                ...
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="g-bg-gray-light-v5 g-pa-20 g-pb-50 mb-4">
                    ...
                    <div id="accordion-03" class="mb-4" role="tablist" aria-multiselectable="true">
                      <div id="accordion-03-heading-03" class="g-brd-y g-brd-gray-light-v2 py-3" role="tab">
                        <h5 class="g-font-weight-400 g-font-size-default mb-0">
                          <a class="g-color-gray-dark-v4 g-text-underline--none--hover" href="#accordion-03-body-03" data-toggle="collapse" data-parent="#accordion-03" aria-expanded="false" aria-controls="accordion-03-body-03">{{$order->items->count()}} items in cart
                      ...
                      <div id="accordion-03-body-03" class="collapse" role="tabpanel" aria-labelledby="accordion-03-heading-03">
                        @include('orders.partials.itemsInCart')
                      </div>
                    </div>
                    <!-- End Accordion -->
                    ...
                    <div class="d-flex justify-content-between mb-2">
                      <span class="g-color-black">Subtotal</span>
                      <span class="g-color-black g-font-weight-300">$ {{$order->subTotal()}}</span>
                    </div>
                    <div class="d-flex justify-content-between">
                      <span class="g-color-black">Order Total</span>
                      <span class="g-color-black g-font-weight-300">$ {{$order->orderTotal()}}</span>
                    </div>
                  </div>
                  <!-- End Order Summary -->
                </div>
              ...
              <div class="row">
                <div class="col-md-8 g-mb-30">
                  ...
                  <div class="g-brd-bottom g-brd-gray-light-v3 g-pb-30 g-mb-30">
                    <div class="text-right">
                      <button class="btn u-btn-primary g-font-size-13 text-uppercase g-px-40 g-py-15" type="submit" formaction="{{route('orders.payment', ['order' => $order->id])}}">Make Payment</button>
                    </div>
                  </div>
                ...
                <div class="col-md-4 g-mb-30">
                  ...
                  <div class="g-bg-gray-light-v5 g-pa-20 g-pb-50 mb-4">
                    ...
                    <div class="d-flex justify-content-between mb-3">
                      <span class="g-color-black">Order Total</span>
                      {{-- the 5.5 refers demo shipping fee  --}}
                      <span class="g-color-black g-font-weight-300">$ {{$order->orderTotal() + 5.5}}</span>
                    </div>
...
@section('script')
  <script>
    $(document).on('ready', function(){
      ...
      //updating sums on the page, but still need to click update shopping cart
/*      $("div.input-group-addon").on('click', 'i.js-plus, i.js-minus', function(){
        var quantityElement = $(this).parent().siblings("input.js-result");
        var quantity = quantityElement.val();
        var price = quantityElement.data('price');
        var itemId = quantityElement.data('item');

        $("span#item-value"+itemId).html("$"+(quantity*price).toFixed(2));
        var subtotal = 0;
        $(".item-value").each(function(i,element){
          value = $(element).html().split('$');
          subtotal += parseFloat(value[1]);
          });
