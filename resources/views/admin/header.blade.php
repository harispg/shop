    ...
    <div class="u-header__section u-header__section--admin-dark g-min-height-65">
      <nav class="navbar no-gutters g-pa-0">
        ...
        <div class="col-auto d-flex g-py-12 g-pl-40--lg ml-auto">
          ...
          <div class="g-pos-rel g-hidden-sm-down g-mr-5">
              ...
              <ul class="p-0 mb-0">
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="/unifyAssets/img-temp/100x100/img5.jpg" alt="Image Description">
                  </div>
            ...
            <i class="hs-admin-time icon-clock g-mr-5"></i> <small>5 Min ago</small>
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="/unifyAssets/img-temp/100x100/img6.jpg" alt="Image Description">
                  </div>
            ...
            <i class="hs-admin-time icon-clock g-mr-5"></i> <small>22 Min ago</small>
                ...
                <li class="media g-pos-rel u-header-dropdown-item-v1 g-pa-20">
                  <div class="d-flex g-mr-15">
                    <img class="g-width-40 g-height-40 rounded-circle" src="/unifyAssets/img-temp/100x100/img7.jpg" alt="Image Description">
                  </div>
        ...
        <span class="u-badge-v2--xs u-badge--top-right g-hidden-sm-up g-bg-secondary g-mr-5"></span>
                <img class="g-width-30 g-width-40--md g-height-30 g-height-40--md rounded-circle g-mr-10--sm" src="/backend/assets/img-temp/130x130/img1.jpg" alt="Image description">
                </span>
