<!-- Calendar Card -->
            <div class="col-xl-4">
              ...
              <!-- Calendar Card -->
              <div class="g-mb-30">
                <header class="u-bg-overlay g-bg-img-hero g-bg-black-opacity-0_5--after g-rounded-4 g-rounded-0--bottom-left g-rounded-0--bottom-right g-overflow-hidden" style="background-image: url(/unifyAssets/img-temp/400x270/img3.jpg);">
