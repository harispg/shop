<!-- Comments Card -->
                ...
                <div class="js-custom-scroll g-height-400 g-pa-15 g-pa-0-30-25--md">
                  <section class="media">
                    <div class="d-flex g-mr-12">
                      <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="/unifyAssets/img-temp/100x100/img5.jpg" alt="Image Description">
                    </div>
            ...
            <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">45 Min <span class="g-hidden-md-down">ago</span></span>
                  ...
                  <section class="media">
                    <div class="d-flex g-mr-12">
                      <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="/unifyAssets/img-temp/100x100/img14.jpg" alt="Image Description">
                    </div>
            ...
            <span class="g-font-weight-300 g-font-size-12 g-font-size-default--md g-color-gray-dark-v6 g-ml-4 g-ml-8--md">15 Min <span class="g-hidden-md-down">ago</span></span>
                  ...
                  <section class="media">
                    <div class="d-flex g-mr-12">
                      <img class="g-width-40 g-width-48--md g-height-40 g-height-48--md rounded-circle" src="/unifyAssets/img-temp/100x100/img7.jpg" alt="Image Description">
                    </div>
